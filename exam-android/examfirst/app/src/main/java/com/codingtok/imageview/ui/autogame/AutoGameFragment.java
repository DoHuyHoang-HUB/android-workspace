package com.codingtok.imageview.ui.autogame;
...
import com.codingtok.imageview.databinding.FragmentAutoGameBinding;
import com.codingtok.imageview.ui.dialog.ConfirmDialog;
import com.google.android.material.dialog.MaterialAlertDialogBuilder;

import java.util.List;

public class AutoGameFragment extends Fragment {

    private FragmentAutoGameBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentAutoGameBinding.inflate(inflater, container, false);
    ...
    public void onViewCreated(@NonNull View viewParent, @Nullable Bundle savedInstanceState) {
        ...
        dialog = new ConfirmDialog(requireContext(), new ConfirmDialog.ConfirmListener() {
            @Override
            public boolean confirm(String value) {
                if (value.trim().isEmpty()) {
                    ...
                    reset();
                    valueTime = Integer.parseInt(value) * 1000;
                    init();
                    return true;
                }
            }
            ...
            @Override
            public void cancel() {
                Navigation.findNavController(binding.getRoot()).navigate(R.id.action_autoGameFragment_to_gameModeFragment);
            }
        });
    ...
    private void init() {
        timer = new CountDownTimer(valueTime, 3000) {
            @Override
        ...
        timer.start();
        binding.textButtonStartGame.setText("Hủy");
    }
